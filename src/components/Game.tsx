...
export function Game({ data, setFirstTeamPoints, setSecondTeamPoints, onGuessConfirm }: Props) {
  ...
  const firstTeamPoints = data.guess?.firstTeamPoints ? String(data.guess.firstTeamPoints) : ''
  const secondTeamPoints = data.guess?.secondTeamPoints ? String(data.guess.secondTeamPoints) : ''
    ...
    >
      ...
      <HStack mt={4} w="full" justifyContent="space-between" alignItems="center">
        <Team
          ...
          onValue={firstTeamPoints === '' ? '0' : firstTeamPoints}
          isDisabled={data.guess === null ? false : true}
        />
        ...
        <Team
          ...
          onValue={secondTeamPoints === '' ? '0' : secondTeamPoints}
          isDisabled={data.guess === null ? false : true}
        />
      </HStack>
